      ...
      <Jumbotron className="contact-jumbotron">
        <Row>
          <Col className="d-flex justify-content-center flex-wrap">
            <div className="m-2">
              <a href="ss.madala22@gmail.com" target="_blank" rel="noopener noreferrer">
                <Button variant="outline-danger" title="ss.madala22@gmail.com">
            ...
            <div className="m-2">
              <a href="https://www.facebook.com/ssm.m.1441" target="_blank" rel="noopener noreferrer">
